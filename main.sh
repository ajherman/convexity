...
srun -N 1 -n 1 -c 20 -o zero_rand.out --open-mode=append ./main_wrapper.sh --train-init zeros --test-init random --batch-dim 20 --learning-rate 2.0 --beta 5.0 --n-epoch 5 --hidden1-size 384 --hidden2-size 256 --output-dir zero_rand --make-tsne &
