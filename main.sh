...
srun -N 1 -n 1 -c 20 -o zero_zero.out --open-mode=append ./main_wrapper.sh --train-init zeros --test-init zeros --batch-dim 20 --learning-rate 2.0 --beta 5.0 --n-epoch 5 --hidden1-size 384 --hidden2-size 256 --output-file zero_zero &
srun -N 1 -n 1 -c 20 -o zero_rand.out --open-mode=append ./main_wrapper.sh --train-init zeros --test-init random --batch-dim 20 --learning-rate 2.0 --beta 5.0 --n-epoch 5 --hidden1-size 384 --hidden2-size 256 --output-file zero_random &
srun -N 1 -n 1 -c 20 -o zero_prev.out --open-mode=append ./main_wrapper.sh --train-init zeros --test-init previous --batch-dim 20 --learning-rate 2.0 --beta 5.0 --n-epoch 5 --hidden1-size 384 --hidden2-size 256 --output-file zero_prev &
srun -N 1 -n 1 -c 20 -o prev_prev.out --open-mode=append ./main_wrapper.sh --train-init previous --test-init previous --batch-dim 20 --learning-rate 2.0 --beta 5.0 --n-epoch 5 --hidden1-size 384 --hidden2-size 256 --output-file prev_prev &
srun -N 1 -n 1 -c 20 -o rand_prev.out --open-mode=append ./main_wrapper.sh --train-init random --test-init previous --batch-dim 20 --learning-rate 2.0 --beta 5.0 --n-epoch 5 --hidden1-size 384 --hidden2-size 256 --output-file rand_prev &
