...
for lr in "${learning_rates[@]}"; do
        ...
        srun -N 1 -n 1 -c $cores -o $name.out --open-mode=append ./main_wrapper.sh  --learning-rate $lr --beta $beta --output-size 20 --batch-dim 20 --init zeros --n-iters 40000 > results.txt
