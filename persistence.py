...
for epoch in range(n_epochs):
    ...
    for itr,batch in enumerate(trainloader): # MNIST
        ...
        h1_free, h2_free, y_free, phase1_energies = minimizeEnergy(model,free_steps,optimizer,x2,h1,h2,y,print_energy=False)

        h1_free, h2_free, y_free, phase1_energies = minimizeEnergy(model,free_steps,optimizer,x2,h1,h2,y,target=target,print_energy=False)
